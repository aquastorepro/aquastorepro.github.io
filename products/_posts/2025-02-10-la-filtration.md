...
Le problème avec ce type de filtre, c'est qu'il faut tout démonter pour le nettoyer, même s'il est possible d'aspirer le gravier. Autre inconvénient : les poissons qui fouillent le substrat, comme le cichlidé par exemple, peuvent endommager le filtre et le rendre inutilisable.

> Le filtre sous-gravier a été quelque peu « oublié » et remplacé par d'autres systèmes de filtration. Il s'agit pourtant d'une solution économique et fiable pour assurer un cycle d'azote complet dans votre aquarium.

**Filtre à gravier**

Le filtre à gravier offre les mêmes avantages que le filtre sous-gravier, sans les inconvénients. Il s'agit essentiellement d'un filtre à boite contenant uniquement du gravier. Facile à nettoyer et à entretenir, il peut, comme le filtre à boite, être fabriqué à moindre coût.
...
Un filtre à boîte est un boîtier muni d'un tube de remontée où l'on place une pierre à air. On peut le remplir de médias biologiques comme les boules céramiques ou de la pouzzolane, recouvertes de ouate ou d'une éponge. L'eau est aspirée par le bas ou par le haut du filtre (voir image ci-dessus), traverse le médias puis ressort par le tube de remontée. Le filtre à boîte est très apprécié des aquariophiles confirmés pour sa simplicité et sa polyvalence.
...
Le filtre interne est le filtre standard que vous pouvez acheter pour votre aquarium. Il existe en différentes tailles, généralement de forme rectangulaire. Certains modèles comportent plusieurs compartiments permettant d'insérer différents types de médias filtrants.
...
>
>Une autre astuce efficace consiste à placer une éponge à l'entrée du filtre. Cela empêche les impuretés de pénétrer dans l'hélice de sa pompe et augmente la surface de contact avec les bactéries bénéfiques.
